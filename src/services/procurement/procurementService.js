...
export const procurementService = {
    ...
    getRequisitions: (params) => axios.get(`${PROCUREMENT_BASE_URL}requisitions/requisitions/`, { params }),
    getRequisition: (id) => axios.get(`${PROCUREMENT_BASE_URL}requisitions/requisitions/${id}/`),
    createRequisition: (data) => axios.post(`${PROCUREMENT_BASE_URL}requisitions/requisitions/`, data),
    updateRequisition: (id, data) => axios.patch(`${PROCUREMENT_BASE_URL}requisitions/requisitions/${id}/`, data),
    deleteRequisition: (id) => axios.delete(`${PROCUREMENT_BASE_URL}requisitions/requisitions/${id}/`),

    // Requisition workflow actions
    publishRequisition: (id) => axios.post(`${PROCUREMENT_BASE_URL}requisitions/requisitions/${id}/publish/`),
    approveRequisition: (id) => axios.post(`${PROCUREMENT_BASE_URL}requisitions/requisitions/${id}/approve/`),
    rejectRequisition: (id) => axios.post(`${PROCUREMENT_BASE_URL}requisitions/requisitions/${id}/reject/`),
    processRequisition: (id) => axios.post(`${PROCUREMENT_BASE_URL}requisitions/requisitions/${id}/process/`),
    convertToOrder: (id) => axios.post(`${PROCUREMENT_BASE_URL}requisitions/requisitions/${id}/convert-to-order/`),
    ...
    getRequisitionOrder: (requisitionId) => axios.get(`${PROCUREMENT_BASE_URL}requisitions/requisitions/${requisitionId}/order/`),
